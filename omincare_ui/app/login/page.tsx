...
import { Activity, Mail, Lock, UserRound, Stethoscope, ArrowRight, Eye, EyeOff } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("https://omnicare-6244.onrender.com/api/auth/login", {
        method: "POST",
